    ...
    <section className="mt-7 rounded-2xl border border-stone-200 bg-white px-6 py-7 shadow-sm sm:px-8">
      ...
      {experience.missing ? (
        ...
        <IndonesianAudioProvider>
          ...
          <ExperienceActions experienceId={experience.id} indonesian={experience.indonesian || ''} harvest={experience.harvest} achievementCatalog={getExperienceCatalog()} nextHref={nextHref} />
        </IndonesianAudioProvider>
      )}
    </section>
  );
