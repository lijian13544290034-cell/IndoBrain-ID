...
const officeItems = (entries: Array<[string, string, string, string]>, groupIndex: number) => entries.map(([chinese, indonesian, example, exampleChinese], index): Essential => ({
  id: `BAS-LIF-OFF-${String(groupIndex * 10 + index + 1).padStart(3, '0')}`,
  module: 'social', category: 'office', chinese, indonesian, example, exampleChinese, aliases: [chinese, indonesian, example], sortOrder: groupIndex * 10 + index + 1,
...
export const lifeBasics: LifeBasicsSection[] = [
  ...
  { slug: 'office', indonesian: 'Kantor', chinese: '办公室', description: '办公室最常用的物品、短句和可直接替换的工作表达。', groups: [
    { title: 'Perangkat kerja', chineseTitle: '办公设备', items: officeItems([
      ['电脑', 'komputer', 'Komputernya sudah menyala belum?', '电脑开了吗？'], ['笔记本电脑', 'laptop', 'Laptop saya ketinggalan di ruang rapat.', '我的笔记本电脑忘在会议室了。'], ['显示器', 'monitor', 'Monitor ini tidak ada gambarnya.', '这个显示器没有画面。'], ['键盘', 'keyboard', 'Keyboard-nya kena air, jangan dipakai dulu.', '键盘进水了，先不要用。'], ['鼠标', 'mouse', 'Mouse saya tidak jalan, boleh pinjam punya kamu?', '我的鼠标不能用，可以借你的么？'], ['鼠标垫', 'alas mouse', 'Di mana alas mouse saya?', '我的鼠标垫在哪里？'], ['打印机', 'printer', 'Printernya rusak, tolong cek ya.', '打印机坏了，请检查一下。'], ['复印机', 'mesin fotokopi', 'Mesin fotokopi sedang dipakai.', '复印机正在使用。'],
    ], 0) },
    { title: 'Dokumen & meja', chineseTitle: '文件与办公区', items: officeItems([
      ['文件', 'dokumen', 'Tolong cetak dokumen ini dua salinan.', '请打印这份文件两份。'], ['文件夹', 'map', 'Tolong masukkan dokumennya ke dalam map.', '请把文件放进文件夹。'], ['文件柜', 'lemari arsip', 'Kontraknya ada di lemari arsip.', '合同在文件柜里。'], ['办公桌', 'meja kerja', 'Taruh berkasnya di meja kerja saya ya.', '请把资料放在我的办公桌上。'], ['椅子', 'kursi', 'Kursinya masih kosong, silakan duduk.', '椅子还空着，请坐。'], ['白板', 'papan tulis', 'Tulis jadwalnya di papan tulis ya.', '请把时间表写在白板上。'], ['记号笔', 'spidol', 'Spidolnya sudah kering, ambil yang baru.', '记号笔没墨了，拿一支新的。'],
    ], 1) },
    { title: 'Alat tulis', chineseTitle: '文具', items: officeItems([
      ['圆珠笔', 'pulpen', 'Boleh pinjam pulpen sebentar?', '可以借我一支圆珠笔吗？'], ['铅笔', 'pensil', 'Pakai pensil dulu untuk tanda sementara.', '临时标记先用铅笔。'], ['橡皮', 'penghapus', 'Penghapusnya ada di laci.', '橡皮在抽屉里。'], ['尺子', 'penggaris', 'Tolong berikan saya penggaris.', '请给我一把尺子。'], ['剪刀', 'gunting', 'Di mana guntingnya?', '剪刀在哪里？'], ['胶水', 'lem', 'Lemnya sudah habis, beli lagi ya.', '胶水用完了，再买一支吧。'], ['胶带', 'selotip', 'Selotipnya ada di mana?', '胶带在哪里？'], ['订书机', 'stapler', 'Stapler ini macet, coba ganti isinya.', '这个订书机卡住了，试着换钉。'], ['回形针', 'klip kertas', 'Pakai klip kertas untuk satukan dokumennya.', '用回形针把文件夹在一起。'],
    ], 2) },
    { title: 'Kantor sehari-hari', chineseTitle: '办公室日常', items: officeItems([
      ['信封', 'amplop', 'Ada amplop di lemari sebelah.', '旁边的柜子里有信封。'], ['名片', 'kartu nama', 'Ini kartu nama saya.', '这是我的名片。'], ['印章', 'stempel', 'Dokumen ini perlu stempel perusahaan.', '这份文件需要公司印章。'], ['互联网', 'internet', 'Koneksi internet di kantor bermasalah.', '办公室的互联网连接有问题。'], ['无线网络', 'Wi-Fi', 'Password Wi-Fi kantor apa ya?', '办公室 Wi-Fi 密码是什么？'], ['空调', 'AC', 'Tolong nyalakan AC, panas sekali.', '请打开空调，太热了。'], ['茶杯', 'cangkir teh', 'Cangkir teh ini milik siapa?', '这个茶杯是谁的？'], ['咖啡', 'kopi', 'Kopinya sudah habis, mau pesan lagi?', '咖啡喝完了，要再点吗？'], ['零食', 'camilan', 'Ada kopi dan camilan di atas meja.', '桌上有咖啡和零食。'],
    ], 3) },
  ] },
