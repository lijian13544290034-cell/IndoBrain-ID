...
export const lifeWorkflow = [
  { slug: 'friends', indonesian: 'Teman', chinese: '朋友', ids: [...range(1, 70), 140, 141, 142, 143, ...range(174, 183)] },
  { slug: 'basics', indonesian: 'Layanan Harian', chinese: '日常服务', ids: [...range(104, 132), ...range(190, 198)] },
  ...
  { slug: 'business', indonesian: 'Bisnis', chinese: '商务沟通', ids: [...range(144, 173), ...range(184, 189)] },
  { slug: 'dating', indonesian: 'Kencan', chinese: '恋爱交友', ids: range(199, 223) },
  { slug: 'rumah-harian', indonesian: 'Rumah Harian', chinese: '居家日常', ids: range(224, 233) },
] as const;
