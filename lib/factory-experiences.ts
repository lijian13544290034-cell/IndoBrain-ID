...
const dialogueOverrides: Record<string, string> = {
  ...
  'EXP-FAC-030': 'Hari ini secara keseluruhan bagaimana?', 'EXP-FAC-031': 'Hari ini efisiensi produksi bagaimana?',
  'EXP-FAC-032': 'Biaya produksi hari ini normal?', 'EXP-FAC-033': 'Hari ini ada barang cacat?',
  'EXP-FAC-034': 'Hari ini ada masalah keselamatan?', 'EXP-FAC-035': 'Area produksi sudah rapi?',
  'EXP-FAC-036': 'Pelanggan mana yang paling mendesak?', 'EXP-FAC-037': 'Pemasok akhir-akhir ini bagaimana?',
  'EXP-FAC-038': 'Hari ini ada perbaikan apa?', 'EXP-FAC-039': 'Tadi pagi sudah pengarahan?',
