...
export const sceneMapV2: SceneMapLevel2[] = [
  ...
  { slug: 'work-business', icon: '💼', title: '工作商务', subtitle: '办公室、工厂、供应商、客户和电商运营。', topics: [
    { slug: 'employee-management', title: '员工管理', subtitle: '员工汇报、完成标准、纪律、离职和责任。', sources: [{ type: 'lifeIds', ids: range(144, 153) }, { type: 'factoryIds', ids: [...range(21, 35), ...range(91, 109)] }] },
  ...
  { slug: 'social-relationship', icon: '🧑‍🤝‍🧑', title: '社交关系', subtitle: '认识朋友、关系推进、聚会、边界和商务社交。', topics: [
    ...
    { slug: 'dating-relationship', title: '恋爱关系', subtitle: '约会、边界、表达好感和关系沟通。', sources: [{ type: 'lifeCategory', category: 'dating' }, { type: 'socialIds', ids: range(301, 319) }] },
