export const nannyWorkflow = [
  { slug: 'makan', indonesian: 'Makan & Minum', chinese: '饮食', ids: [5, 6, 7, 8, 21, 22, 25, 26, 29, 31, 34, 37, 38, 44, 45] },
  { slug: 'rumah', indonesian: 'Pekerjaan Rumah', chinese: '家务', ids: [11, 12, 13, 23, 33, 42, 43] },
  { slug: 'anak', indonesian: 'Anak & Keluarga', chinese: '孩子与家庭', ids: [14, 15, 16, 30, 35, 36, 39, 40] },
  { slug: 'belanja', indonesian: 'Belanja & Tamu', chinese: '采购与待客', ids: [9, 10, 24, 27, 28, 41] },
