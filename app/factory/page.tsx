...
const roles = [
  { indonesian: 'Manajer Pabrik', chinese: '工厂经理', href: '/factory/manager', count: 90 },
    ...
    <main className="mx-auto min-h-screen w-full max-w-3xl px-5 pb-10 pt-14 sm:px-8 sm:pt-20">
      ...
      <header className="mt-8">
        ...
        <nav className="mt-5 grid gap-2 sm:grid-cols-2" aria-label="Mode Pabrik">
          <Link href="/factory" className="min-h-12 rounded-xl border border-stone-900 bg-stone-900 px-4 py-3 text-sm font-medium text-white">Pengalaman（真实场景）<span className="mt-1 block text-xs font-normal text-stone-300">189 situasi</span></Link>
