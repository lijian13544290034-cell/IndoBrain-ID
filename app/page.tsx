...
import PreviewTestModeBanner from '@/components/PreviewTestModeBanner';
import { hasPreviewTestSession } from '@/lib/preview-test-session';
...
export default async function Home() {
  ...
  const previewTestMode = await hasPreviewTestSession();
  return <main className="mx-auto flex min-h-screen w-full max-w-3xl flex-col px-5 pb-8 pt-12 sm:px-8 sm:pb-12 sm:pt-16">
    <header>
      ...
      {previewTestMode && <PreviewTestModeBanner />}
    </header>
